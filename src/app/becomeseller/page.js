...
const Becomeseller = () => {
  ...
  <div className="common_layerstyle__c8PRg"><svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none"><path d="M985.66,92.83C906.67,72,823.78,31,743.84,14.19c-82.26-17.34-168.06-16.33-250.45.39-57.84,11.73-114,31.07-172,41.86A600.21,600.21,0,0,1,0,27.35V120H1200V95.8C1132.19,118.92,1055.71,111.31,985.66,92.83Z" className="common_shape-fill__eGJNR"></path></svg></div>
  </div> */}
...
<div className=" relative bg-no-repeat my-6 bg-left-top bg-[url('/images/image10.png')] h-[600px] w-full">
     ...
     <div className="lg:col-span-2 bg-[#F3FBFF] rounded sm:p-10 p-4 z-20" style={{margin:'125px 0px'}}>
                    ...
                    <div className="flex flex-col md:flex-row">
                        ...
                        <div className="max-w-sm space-y-4 text-start">
                            ...
                            <button type='button'
                                className="text-[#fff] block relative bg-[#0D86C1] hover:bg-gray-200 font-semibold rounded text-sm px-6 py-3">
