...
const Herosection = ({ title,heading, des }) => {
  return (
    <>
      <div className={style["outerBanner"]}>
        <div className="w-[100%] md:w-[80%] mt-[2rem] md:mt-[3rem] mb-[3rem] mx-auto  grid grid-cols-1 md:grid-cols-3 lg:grid-cols-2 gap-[3rem] px-6 py-10">
          <div className="u-max-w-[480px] u-space-y-2 u-leading-tight">
            ...
            <h3 className="text-2xl font-extrabold tracking-[-0.04em] text-white sm:text-3xl sm:leading-[3.5rem]">{heading}</h3>
      ...
      <section>
        <h2 className="mt-[1.5rem] text-center text-[28px] text-black font-semibold mb-4">Best seller Products</h2>
          ...
          <li className="bg-base-300 card mb-4" key={i}> <Image className="h-[200px] w-[250px] mx-auto" src={item.imgseller} width={250} height={200} alt='imgseller'/>
          <h3>{item.name}</h3>
        </li>
          )}
          </ul>
      ...
      <section>
        ...
        <h2 className="mt-[1rem] text-center text-[28px] text-black font-semibold mb-4">Why Choose Us</h2>
          <div className="w-[90%] md:w-[80%] mb-[3rem] mx-auto  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-[3rem]">
            ...
            <Image className="h-full w-auto mx-auto px-2" src='/Fish1.png' width={350} height={252} alt='logo'/>
              </div>
            </div>
            <div
              data-aos="zoom-in"
            ...
            >
              <div className="py-6 hover:bg-white lg:translate-y-[1rem] rounded-lg transition-all duration-200">
                ...
                At Unicorn Seafoods, we transcend the ordinary to offer an extraordinary seafood experience. Our commitment to excellence starts from the source, with direct partnerships ensuring the freshest catch from fishermen and farmers worldwide.</p>
                <p className="mt-[1rem] text-black text-opacity-60 text-start">
                At Unicorn Seafoods, we transcend the ordinary to offer an extraordinary seafood experience. Our commitment to excellence starts from the source, with direct partnerships ensuring the freshest catch from fishermen and farmers worldwide.</p>
                <p className="mt-[1rem] text-black text-opacity-60 text-start">
                At Unicorn Seafoods, we transcend the ordinary to offer an extraordinary seafood experience. Our commitment to excellence starts from the source, with direct partnerships ensuring the freshest catch from fishermen and farmers worldwide.
                </p>
              </div>
            </div>
      ...
      <h2 className="mt-[1rem] text-center text-[28px] text-black font-semibold mb-4">Why Choose Us</h2>
      <p className="mt-[1rem] text-black text-opacity-60 text-center">We ensure the products are certified with necessary quality assurance required as per the, buying country standards. Our products also undergo a thorough inspection by our local quality agents.</p>
      <div>
        <CertificateSlide/>
      </div>
      </div>
